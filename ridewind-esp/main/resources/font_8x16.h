...
/**
 * 8×16 bitmap font for ASCII printable characters (space 0x20 through tilde 0x7E).
 * Each character is 8 pixels wide × 16 pixels tall, stored as 16 bytes (one byte per row).
 * Bit 7 (MSB) is the leftmost pixel.
 *
 * Index into the array: font_8x16[ch - 0x20]
 */
static const uint8_t font_8x16[][16] = {
 ...
 /* 0x57 'W' */ {0x00,0x00,0xC6,0xC6,0xC6,0xC6,0xC6,0xD6,0xD6,0xFE,0xEE,0x6C,0x00,0x00,0x00,0x00},
