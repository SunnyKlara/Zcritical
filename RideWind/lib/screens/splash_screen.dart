...
class _SplashScreenState extends State<SplashScreen>
  ...
  // TapGestureRecognizer 需要手动 dispose 防止内存泄漏
  final _userAgreementTap = TapGestureRecognizer();
  ...
  void initState() {
    ...
    // 设置协议链接点击事件
    _userAgreementTap.onTap = () => _showAgreementPage('用户协议');
    _privacyPolicyTap.onTap = () => _showAgreementPage('隐私政策');
...
一、服务条款的接受
感谢您使用 Critical 产品和服务。请您仔细阅读以下条款，如果您使用 Critical 服务，即表示您同意遵守下述全部条款。

二、服务说明
Critical 是一款智能设备控制应用，为用户提供设备连接、控制和管理等功能。
...
六、知识产权
Critical 的所有内容，包括但不限于软件、界面设计、文字、图片等，均受相关知识产权法律保护。
...
引言
Critical（以下简称"我们"）非常重视用户的隐私和个人信息保护。本隐私政策将帮助您了解我们如何收集、使用、存储和保护您的个人信息。

一、我们收集的信息
1. 设备信息：包括设备型号、操作系统版本、设备标识符等。
2. 蓝牙信息：用于连接和控制您的 Critical 设备。
